...
benchmarks results represent each algorithm's
performance on a set of uniformly sampled plane triangulations with
uniformly sampled representations in memory.
