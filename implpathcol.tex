...
Wrk[$u$] will be $(v,r_v(u))$; for details on why this is, see below. Look up and assign references for the
edge $uv$ in Adj'. Remove $(v,r_v(u))$ from the back of Wrk[$u$].
\end{algorithm}
