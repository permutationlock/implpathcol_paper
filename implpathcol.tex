...
\newcommand{\SolidGraph}{
    ...
    \tikzset{
        every node/.style={circle, inner sep=1mm, fill, draw, minimum size=2mm,
        scale=0.85}
    }
}
...
\begin{tikzpicture}[scale=1.2]
  ...
  \node (t3) at (-3.675cm, 0cm) {};
    ...
    \node (k1) [label=above left:$1$, label=below:$1$] at (-1.875cm, 0.65cm) {};
    \node (k2) [label=below:$2$] at (-0.75cm, 0.65cm) {};
    \node (k3) [label=below:$3$] at (0.375cm, 0.65cm) {};
    \node (kn) [label=below:$k$] at (1.875cm, 0.65cm) {};

    \node (l1) [label=above left:$2$] at (-1.32cm, 1.15cm) {};
    \node (l2) at (-0.18cm, 1.15cm) {};
    \node (ln) at (1.32cm, 1.15cm) {};

  \node (j1) [label=above left:$3$] at (-0.75cm, 1.65cm) {};
  \node (jn) at (0.75cm, 1.65cm) {};

  \node (p) [label=above left:$3$] at (0cm, 2.4cm) {};
...
and $u_k$ is the vertex immediately clockwise from $z$.
...
\begin{tikzpicture}[scale=1.4]
    ...
    \node (botb) [empty] at (3.75cm, 0.0cm) {};

    \node (bs) [empty] at (1.6cm, 0.5cm) {};
    \node (be) [empty] at (2.9cm, 0.5cm) {};
...
$\quad$
\begin{tikzpicture}[scale=1.4]
    \node (u1) at (0.0cm, 1.25cm) [label=above:${u_1}$] {};
    \node (y) at (1.5cm, 0.25cm) [label=below:${y}$] {};
    \node (z) at (1.5cm, 1.25cm) [label=above:${z}$] {};
...
was run on $100$ random plane triangulations; see the timings in
...
Case~3.2.1 with $u_2=x$, Case~3.2.2, and
Case~3.2.3.1 with $u_2=y$.
Unfortunately, in Case~3.2.1 with $u_2\ne x$ and Case~3.2.3.2 with $u_2\ne y$,
the second call will always depend on the reduced list $L[u_2]$
