...
to $u_jv_\ell$. Therefore $c[v']=c_{P_2}$, and it must be
...
For each $i$ in $4\ldots 7$, a set of $100$ random plane triangulations
of order $10^i$ was
...
\hline
    Algorithm~\ref{A:poh_bfs} & 
    $7.77\cdot 10^{6}$ &
    $3.09\cdot 10^{8}$ & $1.22\cdot 10^{10}$ &
    $6.82\cdot 10^{11}$ \\
\hline
    Algorithm~\ref{A:poh_linear} & 
    $2.52\cdot 10^{5}$ &
    $3.11\cdot 10^{6}$ & $4.61\cdot 10^{7}$ &
    $1.17\cdot 10^{9}$ \\
\hline
    Algorithm~\ref{A:poh_bfs} (flipped) & 
    $7.59\cdot 10^{6}$ &
    $3.56\cdot 10^{8}$ & $2.76\cdot 10^{10}$ &
    $1.19\cdot 10^{12}$ \\
\hline
    Algorithm~\ref{A:poh_linear} (flipped) & 
    $2.20\cdot 10^{5}$ &
    $2.20\cdot 10^{6}$ & $2.31\cdot 10^{7}$ &
    $2.31\cdot 10^{8}$ \\
\end{tabular}
...
\hline
    ...
    $4.25\cdot 10^{5}$ &
    $3.92\cdot 10^{6}$ & $7.62\cdot 10^{7}$ &
    $9.22\cdot 10^{8}$ \\
\hline
    3 & % $4.28\cdot 10^{2}$ & $6.48\cdot 10^3$ &
    $3.60\cdot 10^{5}$ &
    $3.08\cdot 10^{6}$ & $5.78\cdot 10^{7}$ &
    $6.95\cdot 10^{8}$ \\
\hline
    4 & % $4.28\cdot 10^{2}$ & $6.48\cdot 10^3$ &
    $3.49\cdot 10^{5}$ &
    $2.80\cdot 10^{6}$ & $4.98\cdot 10^{7}$ &
    $5.94\cdot 10^{8}$ \\
\end{tabular}
...
\hline
    ...
    $6.23\cdot 10^{5}$ &
    $6.72\cdot 10^{6}$ & $1.15\cdot 10^{8}$ &
    $1.31\cdot 10^{9}$ \\
\hline
    3 & % $7.62\cdot 10^{2}$ & $9.30\cdot 10^3$ &
    $5.81\cdot 10^{5}$ &
    $5.96\cdot 10^{6}$ & $9.03\cdot 10^{7}$ &
    $1.01\cdot 10^{9}$ \\
\hline
    4 & % $7.62\cdot 10^{2}$ & $9.30\cdot 10^3$ &
    $6.26\cdot 10^{5}$ &
    $6.02\cdot 10^{6}$ & $8.09\cdot 10^{7}$ &
    $8.88\cdot 10^{8}$ \\
\end{tabular}
...
showed performance benefits when applying the parallel
version of Algorithm~\ref{A:hartman_impl} to plane graphs on the order
of $10^6$ vertices or more. Once again, the same set of random plane
