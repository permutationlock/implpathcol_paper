...
in the plane,
then the rotation scheme completely specifies the combinatorial
embedding of the graph.
Rotation schemes are particularly convenient when we represent a graph
...
[\textit{Get correct title for Bross reference,
from grad school forms.} %!!!
